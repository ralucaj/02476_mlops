...
lr = 1e-3
epochs = 5
train_set_path = "data/processed/mnist_train.pt"
test_set_path = "data/processed/mnist_test.pt"
...
wandb.log({"examples": [wandb.Image(x_hat.view(batch_size, 1, 28, 28))]})
...
wandb.log({"examples": [wandb.Image(generated_images.view(batch_size, 1, 28, 28))]})
